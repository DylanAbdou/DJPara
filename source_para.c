...
//fonction rajouté par Dylan : afficher le tab d[] qui contient les distances du plus court chemin entre chaque point.
void afficherDistances();
//ecriture du resultat de la fonction dans un fichier dans le but de faire un "diff" avec les versions paralélisé.
char *concat();
